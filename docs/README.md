...
- [MIMIC_POLICY.md](MIMIC_POLICY.md)
...
- [UPSTREAM_SYNC_POLICY.md](UPSTREAM_SYNC_POLICY.md)
...
- [UPSTREAM_PROFILE_REQUEST_DRAFT.md](UPSTREAM_PROFILE_REQUEST_DRAFT.md)
  - draft text for requesting a general profile / option mechanism upstream in `mikuscore`
- [UPSTREAM_SYNC_RETROSPECTIVE_2026-04-06.md](UPSTREAM_SYNC_RETROSPECTIVE_2026-04-06.md)
